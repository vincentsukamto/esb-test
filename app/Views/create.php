        ...
        <div class="col-12">
          <div class="card" style="padding:20px">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="number" name="subtotal" min="0" placeholder="Subtotal" id="subtotal" readonly>
            </div>
            <div class="form-group">
                <label for="tax">TAX (10%)</label>
                <input class="form-control" type="number" name="tax" min="0" placeholder="Tax" id="tax" readonly>
            </div>
            <div class="form-group">
                <label for="payment">PAYMENT</label>
                <input class="form-control" type="number" name="payment" min="0" placeholder="Payment" id="payment" oninput="countAmountDue()">
            </div>
            <div class="form-group">
                <label for="amount_due">AMOUNT DUE</label>
                <input class="form-control" type="number" name="amount_due" min="0" placeholder="Amount Due" id="amount_due" readonly>
            </div>
            <div class="form-group">
            ...
            <div class="form-group" align="center">
                ...
                <table id="invoice_item">
                    <tr class="rowProduct">
                        <input type="hidden" name="array_count[0]" value="0">
                        <td>
                            <label for="item_type0">ITEM TYPE</label>
                            <input class="form-control" type="text" name="item_type0" placeholder="Item Type" id="item_type0">
                        </td>
                        <td>
                            <label for="description0">DESCRIPTION</label>
                            <input class="form-control" type="text" name="description0" placeholder="Description" id="description0">
                        </td>
                        <td>
                            <label for="quantity0">QUANTITY</label>
                            <input class="form-control" type="number" name="quantity0" min="0" placeholder="Quantity" id="quantity0" oninput="countSubtotal()">
                        </td>
                        <td>
                            <label for="unit_price0">UNIT PRICE</label>
                            <input class="form-control" type="number" name="unit_price0" min="0" placeholder="Unit Price" id="unit_price0" oninput="countSubtotal()">
                        </td>
                        <td>
                            <label for="amount0">AMOUNT</label>
                            <input class="form-control" type="number" name="amount0" min="0" placeholder="Amount" id="amount0" readonly>
                        </td>
                    </tr>
